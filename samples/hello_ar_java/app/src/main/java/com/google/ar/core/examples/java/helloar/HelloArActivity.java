        ...
        settingsButton.setOnClickListener(
                new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        // TODO: testing...
                        String msg = Arrays.toString(focalLength) + "\n" +
                                Arrays.toString(imageDimensions) + "\n" +
                                Arrays.toString(principalPoint) + "\n";
    ...
    public void onDrawFrame(SampleRender render) {
        ...
        try {
            ...
            if (frame != null) {
                ...
                focalLength = cameraIntrinsics.getFocalLength();
                imageDimensions = cameraIntrinsics.getImageDimensions();
                principalPoint = cameraIntrinsics.getPrincipalPoint();
            }

        } catch (Exception e) {
            Log.e("ww", e.toString());
//            Log.e(TAG, "Camera not available during onDrawFrame", e);
            messageSnackbarHelper.showError(this, e.toString());
//            messageSnackbarHelper.showError(this, "Camera not available. Try restarting the app.");
            return;
        }
